...
var split = function(){
	...
	if(hituje == false){
				...
				setTimeout(function(){
					...
					setTimeout(function(){
						if(rekaGracza[0].slice(0,-2)==rekaGracza[1].slice(0,-2)){
							//max 3 splity
							if(nowy<2){
								document.getElementById("split").display="block";
							}
						}
		...
		sumagr2.id="sumaspl"+nowy;
		sumagr2.innerHTML = "<span></span>";
		sumagr2.className="sumy";
		sumagr2.style.left="65%";
		sumagr2.style.top=1+(nowy*16)+"%";
